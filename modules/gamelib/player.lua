...
ConditionIcons = {
    [1] = {
        ...
        clip = 1,
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-00.png',
        name = "poisoned",
    ...
    [2] = {
        ...
        clip = 2,
        name = "burning",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-01.png',
    ...
    [3] = {
        ...
        clip = 3,
        name = "electrified",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-02.png',
    ...
    [4] = {
        ...
        clip = 16,
        name = "bleeding",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-15.png',
    ...
    [5] = {
        ...
        clip = 28,
        name = "agony",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-27.png',
        id = 'condition_Agony',
        visibleHud = true,
        visibleBar = true,
    ...
    [6] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-28.png',
        visibleHud = true,
        visibleBar = true,
    ...
    [7] = {
        ...
        name = "rooted",
        id = 'condition_Rooted',
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-19.png',
        visibleHud = true,
        visibleBar = true,
    ...
    [8] = {
        ...
        name = "feared",
        id = 'condition_Feared',
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-20.png',
        visibleHud = true,
        visibleBar = true,
    ...
    [9] = {
        ...
        clip = 4,
        name = "drunk",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-03.png',
        id = 'condition_drunk',
        visibleHud = true,
        visibleBar = true,
    ...
    [10] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-26.png',
        visibleHud = true,
        visibleBar = true,
    ...
    [11] = {
        ...
        clip = 6,
        name = "slowed",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-05.png',
        id = 'condition_slowed',
        visibleHud = true,
        visibleBar = true,
    ...
    [12] = {
        ...
        clip = 7,
        name = "haste",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-06.png',
        id = 'condition_haste',
        visibleHud = true,
        visibleBar = true,
    ...
    [13] = {
        ...
        clip = 8,
        name = "logout block",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-07.png',
    ...
    [14] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-08.png',
        visibleHud = true,
        visibleBar = true,
    ...
    [15] = {
        ...
        clip = 10,
        name = "freezing",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-09.png',
    ...
    [16] = {
        ...
        clip = 11,
        name = "dazzled",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-10.png',
    ...
    [17] = {
        ...
        clip = 12,
        name = "cursed",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-11.png',
        id = 'condition_cursed',
        visibleHud = true,
        visibleBar = true,
    ...
    [18] = {
        ...
        clip = 34,
        name = "mentor other",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-29.png',
    ...
    [19] = {
        ...
        clip = 13,
        name = "strengthened",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-12.png',
    ...
    [20] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-13.png',
    ...
    [21] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-14.png',
        id = 'condition_Pigeon',
        visibleHud = false,
        visibleBar = true,
    ...
    [22] = {
        ...
        name = "resting area",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-client-00.png',
    ...
    [23] = {
        ...
        clip = 17,
        name = "lesser hex",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-16.png',
    ...
    [24] = {
        ...
        clip = 18,
        name = "intenser hex",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-17.png',
    ...
    [25] = {
        ...
        clip = 19,
        name = "greater hex",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-18.png',
    ...
    [26] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-25.png',
        id = "condition_curse",
    ...
    [27] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-rotten-blood-08.png',
        id = "condition_taints",
        tooltipBar = tr(''),
        visibleHud = false,
        visibleBar = true,
    ...
    [28] = {
        skull = SkullYellow,
        name = "yellow skull",
        path = '/modules/game_healthcircle/images/conditions/player-state-playerkiller-flags-00.png',
        id = "skullyellow",
    ...
    [29] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-playerkiller-flags-01.png',
        visibleHud = true,
        visibleBar = true,
        tooltip = tr(
    ...
    [30] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-playerkiller-flags-02.png',
        visibleHud = true,
        visibleBar = true,
        tooltip = tr(
    ...
    [31] = {
        ...
        path = '/modules/game_healthcircle/images/conditions/player-state-playerkiller-flags-03.png',
        visibleHud = true,
        visibleBar = true,
        tooltip = tr(
    ...
    [32] = {
        ...
        name = "black skull",
        tooltipBar = tr(''),
        path = '/modules/game_healthcircle/images/conditions/player-state-playerkiller-flags-04.png',
        id = "skullblack",
        visibleHud = true,
        visibleBar = true,
        tooltip = tr(
    ...
    [33] = {
        skull = SkullOrange,
        name = "orange skull",
        path = '/modules/game_healthcircle/images/conditions/player-state-playerkiller-flags-05.png',
        id = "skullorange",
    ...
    [34] = {
        ...
        path = "/modules/game_healthcircle/images/conditions/player-state-guildwar-flag",
        name = "in guild war",
        id = "emblem",
        visibleHud = false,
        visibleBar = true,
    ...
    [35] = {
        ...
        clip = 32,
        name = "hungry",
        path = '/modules/game_healthcircle/images/conditions/player-state-flags-client-02.png',
        id = 'condition_hungry',
        visibleHud = false,
        visibleBar = true,
